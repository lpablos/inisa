            ...
            <form onSubmit={handleSubmit(enviarFormulario)}>
                <div className="card flex flex-wrap gap-4 p-fluid">
                    ...
                    <div className="flex-auto">
                        ...
                        />
                        {errors.telefono && (
                            <small id="telefono-help" className="text-red-500">
                    ...
                    <div className="flex-auto">
                        ...
                        />
                        {errors.colonia && (
                            <small id="colonia-help" className="text-red-500">
                    ...
                    <div className="flex-auto">
                        ...
                        />
                        {errors.direccion && (
                            <small id="direccion-help" className="text-red-500">
