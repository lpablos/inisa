<table style="border-collapse: collapse; width: 100%;">
    <thead>
        <tr style="border: 1px solid #000; text-align: center;">
            ...
            <th colspan="4"
                style="background-color: #c0c0c0; font-weight: bold; text-align: center;  width: 100px; border: 1px solid #000">
                COSTO DE
                MATERIALES</th>
        ...
        <tr>
            <th rowspan="2"
                style="background-color: #FFF2CC; font-weight: bold; text-align: center;  width: 100px; border: 1px solid #000">
                UNID</th>
            <th rowspan="2"
                style="background-color: #FFF2CC; font-weight: bold; text-align: center;  width: 100px; border: 1px solid #000">
                CANT.</th>
            <td colspan="2"
                ...
                PESOS M.N.</td>
            <td colspan="2"
                style="background-color: #ccffff; font-weight: bold; text-align: center;  width: 100px; border: 1px solid #000">
                PESOS M.N.</td>
            <td colspan="2"
                style="background-color: #c0c0c0; font-weight: bold; text-align: center;  width: 100px; border: 1px solid #000">
                PESOS M.N.</td>
        ...
        <tr>
            ...
            <td colspan="1"
                style="background-color: #FFF2CC; font-weight: bold; text-align: center; width: 150px; border: 1px solid #000">
                COSTO UNITARIO
            </td>
            <td colspan="1"
                style="background-color: #FFF2CC; font-weight: bold; text-align: center; width: 100px; border: 1px solid #000">
